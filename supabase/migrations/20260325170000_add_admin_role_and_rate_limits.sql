...
drop policy if exists "request_rate_limits_no_direct_access" on public.request_rate_limits;
create policy "request_rate_limits_no_direct_access"
...
declare
  ...
  v_window request_rate_limits%rowtype;
